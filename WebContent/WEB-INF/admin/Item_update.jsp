                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="Item" method="Post">
                        			 ...
                        			 <input type="hidden" id="id" name="id" value="${bean.itemId}">
			                          ...
			                          <div class="col-sm-9">
			                            <input id="itemName" type="text" placeholder="请输入分类名称"  name="itemName"  value="${itemName!=null?itemName:bean.itemName}" class="form-control form-control-warning">
