                            ...
                            <div class="row">
                                <div class="col-lg-12">
                        			...
                        			<input type="hidden" name="oper" value="insertDeal"/>
			                          ...
			                          <div class="col-sm-9">
			                            <input id="userName" type="text" placeholder="请输入账号"  name="userName"  value="${userName}" class="form-control form-control-warning">
			                          ...
			                          <div class="col-sm-9">
			                            <input id="userPass2" type="password" placeholder="请再次输入密码  " name="userPass2"  value="${userPass2}" class="form-control form-control-warning">
			                            <small class="form-text"></small>
			                          </div>
			                          </div>
