                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="User" method="Post">
                        			 ...
                        			 <input type="hidden" id="id" name="id" value="${bean.userId}">
			                          ...
			                          <div class="col-sm-9">
			                            <input id="userName" type="text" placeholder="请输入用户名"  name="userName"  value="${userName!=null?userName:bean.userName}" class="form-control form-control-warning">
			                          ...
			                          <div class="col-sm-9">
			                            <input id="name" type="text" placeholder="请输入真实姓名"  name="name"  value="${name!=null?name:bean.name}" class="form-control form-control-warning">
			                            <small class="form-text"></small>
			                          </div>
			                          </div>
			                           <div class="form-group row">
			                          ...
			                          <div class="col-sm-9">
			                            <input id="email" type="text" placeholder="请输入邮箱"  name="email"  value="${email!=null?email:bean.email}" class="form-control form-control-warning">
			                            <small class="form-text"></small>
			                          </div>
			                          </div>
			                          ...
			                          <div class="col-sm-9">
			                            <input id=address type="text" placeholder="请输入地址"  name="address"  value="${address!=null?address:bean.address}" class="form-control form-control-warning">
			                            <small class="form-text"></small>
			                          </div>
			                          </div>
			                           <div class="form-group row">
			                          ...
			                          <div class="col-sm-9">
			                            <input id="code" type="text" placeholder="请输入激活码"  name="code"  value="${code!=null?code:bean.code}" class="form-control form-control-warning">
			                            <small class="form-text"></small>
			                          </div>
			                          </div>
