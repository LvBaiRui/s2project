			...
			<div id="page-inner">
				...
				<div class="panel panel-default">
					...
					<div class="panel-heading"></div>
					    ...
					    <form action="User" method='GET' id='listform'>
			                ...
			                <input type='button' class="btn btn-warning" onclick="javascript:location.href='User?oper=list'"  value='清空' />
                
                		</form>
                		
                		
					<div class="panel-body">
					<button onclick="javascript:location.href='User?oper=insert'"  class="btn btn-success">添加</button>   &nbsp;&nbsp;  <button onclick='javascript:datadel()' class="btn btn-success">批量删除</button>&nbsp;&nbsp;
						<div class="table-responsive">
								...
								<table class="table table-striped table-bordered table-hover" id="dataList">
					                 ...
					                 <tr>
					                 <td><input type='checkbox' id="line${bean.userId}"  value='${bean.userId}' /></td>
									<td>${status.count}</td>
					                 <td>${bean.userId}</td>
					                 <td>${bean.userName}</td>
					                 <td>${bean.name}</td>
					                 <td>${bean.email}</td>
					                 <td>${bean.address}</td>
					                 <td>${bean.status==0?"未激活":"已激活"}</td>
					                 <td>${bean.code}</td>
					                 <td>
					                <a href="javascript:item_del(this,${bean.userId});">删除</a>&nbsp;&nbsp;
								    <a href="User?oper=update&id=${bean.userId}">修改</a>&nbsp;&nbsp;
								    <a href="User?oper=detail&id=${bean.userId}">查看</a>     
					                 </td>
					                 </tr>
									</c:forEach>          
