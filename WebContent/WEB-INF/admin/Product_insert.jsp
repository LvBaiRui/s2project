                            ...
                            <div class="row">
                                <div class="col-lg-12">
                        			...
                        			<input type="hidden" name="oper" value="insertDeal"/>
			                          ...
			                          <div class="col-sm-9">
			                            <input id="proName" type="text" placeholder="请输入商品名称"  name="proName"  value="${proName}" class="form-control form-control-warning">
			                          ...
			                          <div class="col-sm-9">
			                            <input id="proPrice" type="text" placeholder="请输入商品价格"  name="proPrice"  value="${proPrice}" class="form-control form-control-warning">
			                            <small class="form-text"></small>
			                          </div>
			                          </div>
			                           <div class="form-group row">
			                          ...
			                          <div class="col-sm-9">
			                            <input id="marketPrice" type="text" placeholder="请输入商品价格"  name="marketPrice"  value="${marketPrice}" class="form-control form-control-warning">
			                            <small class="form-text"></small>
			                          </div>
			                          </div>
			                           <div class="form-group row">
			                          ...
			                          <div class="col-sm-9">
			                            <input id="productInfo" type="text" placeholder="请对商品进行描述  " name="productInfo"  value="${productInfo}" class="form-control form-control-warning">
			                            <small class="form-text"></small>
			                          </div>
			                          </div>
			                          <div class="form-group row">
			                          ...
			                          <div class="col-sm-9">
			                            <input id="image" type="file" placeholder="请添加图片  " name="image"  value="${image}" class="form-control form-control-warning">
			                            <small class="form-text"></small>
			                          </div>
			                          </div>
			                           <div class="form-group row">
