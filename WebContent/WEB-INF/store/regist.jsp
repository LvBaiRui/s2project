		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
                    ...
                    <input type="hidden" name="oper" value="registDeal"/>
						<table>
							<tbody><tr>
								<th>
								...
								<td>
								<input type="text" id="username" class="text" maxlength="20" placeholder="请输入用户名" name="userName" value="${userName}"/>
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="password"  class="text" maxlength="20" autocomplete="off" placeholder="请输入确认密码" name="userPass2"/>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text" id="email" class="text" maxlength="200" placeholder="Email"  name="email" value="${email}"/>
								</td>
							</tr>
									<tr>
										<th>
										...
										<td>
												<input type="text"  class="text" maxlength="200" placeholder="请输入姓名" name="name" value="${name}"/>
										</td>
									</tr>
									<tr>
										<th>
									...
									<tr>
										...
										<td>
												<input type="text" class="text" maxlength="200"  name="address" value="${address}"/>
										</td>
									</tr>
